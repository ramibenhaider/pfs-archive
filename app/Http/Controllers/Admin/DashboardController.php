...
class DashboardController extends Controller
{
    public function permissions () {
        ...
        $users = User::with('permissions')->where('role', 'user')->orderByDesc('created_at')->get();
    ...
    public function fields()
    {
        ...
        return view('admin.fields', compact('companies', 'document_types', 'job_titles', 'management', 'nationalities', 'company_document_types'));
    }
}
