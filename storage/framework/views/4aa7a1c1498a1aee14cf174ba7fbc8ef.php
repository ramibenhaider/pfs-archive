    ...
    <div class="form-grid" style="grid-template-columns: repeat(auto-fill, minmax(350px, 1fr));">
        ...
        <div class="side-card-unique">
            <div class="side-card-header d-flex justify-content-between align-items-center">
                ...
                <span class="total-count-badge"><?php echo e($companies->count() ?? 0); ?></span>
            </div>
            <div class="p-3 bg-white">
                <form action="<?php echo e(route('admin.company.store')); ?>" method="POST" class="search-form">
                    <?php echo csrf_field(); ?>
                    <input type="text" name="company_name" class="<?php $__errorArgs = ['company_name', 'company_name.create'];
...
unset($__errorArgs, $__bag); ?>" placeholder="إضافة شركة جديدة..." required>
                    <button type="submit" class="search-submit">إضافة</button>
                </form>
                <?php $__errorArgs = ['company_name', 'company_name.create'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="side-list">
                    <?php $__errorArgs = ['company_name', 'company_name.edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            <form action="<?php echo e(route('admin.company.update', encodeId($company->id))); ?>" method="POST" class="d-flex align-items-center flex-grow-1">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="text" name="company_name" value="<?php echo e($company->company_name); ?>" class="form-control me-2">
                                <button type="submit" style="border:none; background:none; color:blue; white-space:nowrap;">تعديل</button>
                            </form>
                            <form action="<?php echo e(route('admin.company.destroy', encodeId($company->id))); ?>" onsubmit="return confirm('هل أنت متأكد؟')" method="POST" class="m-0 ms-2">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="side-card-unique">
            <div class="side-card-header d-flex justify-content-between align-items-center">
                ...
                <span class="total-count-badge"><?php echo e($company_document_types->count() ?? 0); ?></span>
            </div>
            <div class="p-3 bg-white">
                <form action="<?php echo e(route('admin.company_document_type.store')); ?>" method="POST" class="mb-2">
                    <?php echo csrf_field(); ?>
                    <div class="d-flex flex-column gap-2">
                        <input type="text" name="name" class="form-control form-control-sm <?php $__errorArgs = ['name', 'name.create'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="نوع (عربي)..." required>
                        <input type="text" name="nameEn" class="form-control form-control-sm <?php $__errorArgs = ['nameEn', 'name.create'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Type (En)..." required>
                ...
                <?php if($errors->hasBag('name.create')): ?> <div class="invalid-feedback mb-2"><?php echo e($errors->getBag('name.create')->first()); ?></div> <?php endif; ?>

                <div class="side-list">
                    <?php $__errorArgs = ['name', 'name.edit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback border-bottom pb-2"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    <?php $__currentLoopData = $company_document_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company_document_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center border-bottom py-2">
                            <form action="<?php echo e(route('admin.company_document_type.update', encodeId($company_document_type->id))); ?>" method="POST" class="d-flex align-items-center flex-grow-1">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="text" name="name" value="<?php echo e($company_document_type->name); ?>" class="form-control form-control-sm me-2">
                                <input type="hidden" name="nameEn" value="<?php echo e($company_document_type->nameEn); ?>">
                                <button type="submit" style="border:none; background:none; color:blue; white-space:nowrap;">تعديل</button>
                            </form>
                            <form action="<?php echo e(route('admin.company_document_type.destroy', encodeId($company_document_type->id))); ?>" onsubmit="return confirm('هل أنت متأكد من الحذف؟')" method="POST" class="ms-2">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" style="border:none; background:none; color:red; white-space:nowrap;">حذف</button>
                            </form>
