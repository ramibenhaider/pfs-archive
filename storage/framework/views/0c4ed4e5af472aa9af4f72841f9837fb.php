...
<div class="container-createEmployee">
    <div class="mb-3">
        <a href="<?php echo e(route('user.employee.show', $employee->id)); ?>" class="btn-back-note" style="text-decoration: none; display: inline-flex; align-items: center; gap: 8px;">
            <span>&larr;</span> رجوع
        </a>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.index-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\archive-nags\resources\views/user/document/show.blade.php ENDPATH**/ ?>