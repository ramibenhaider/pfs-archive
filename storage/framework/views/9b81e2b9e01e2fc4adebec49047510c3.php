                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center gap-2">
                            <a href="<?php echo e(route('note.edit', $note->id)); ?>" class="btn btn-edit-sm">عرض</a>
                            <form method="POST" action="<?php echo e(route('note.destroy', $note->id)); ?>" onsubmit="return confirm('حذف؟')">
                                <?php echo csrf_field(); ?>
