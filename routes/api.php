...
use App\Http\Controllers\Api\User\DataController;
...
Route::middleware('auth:sanctum')->group(function() {
    ...
    Route::apiResource('myNotes', MyNoteController::class);
...
Route::prefix('admin')->group(function() {
    ...
    Route::middleware(['auth:sanctum', 'checkAdminApi'])->group(function() {
        ...
        Route::apiResource('company', CompanyController::class)->only(['store', 'update', 'destroy']);
